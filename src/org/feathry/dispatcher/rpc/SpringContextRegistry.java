...
public class SpringContextRegistry implements ApplicationContextAware, ServiceRegistry
{
	...
	public Object invoke(RemoteProcedureCall rpc) throws Throwable
	{
		...
		Class<?> serviceInterface = this.getServiceInterface(rpc.getServiceName());
		ServiceDispatcher handler;
		if(serviceInterface == null)
		{
			handler = new ServiceDispatcher(service);
		}
		else
		{
			handler = new ServiceDispatcher(serviceInterface, service);
		}
