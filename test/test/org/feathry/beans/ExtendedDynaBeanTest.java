package test.org.feathry.beans;
...
import org.feathry.beans.ChoiceException;
...
public class ExtendedDynaBeanTest
{
	...
	public void testGetSimilarityDynaBean()
	{
		...
		// InnerDummyBean properties: class, age, id = 3 total
		// TestDummyBean properties: class, age, name, innerDummy = 4 total
		// Equal: class, age = 2 / 4 = 0.5
		assertEquals(0.666, edb.getSimilarity(InnerDummyBean.class), 0.001);
	}
